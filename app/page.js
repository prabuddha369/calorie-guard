            ...
            <div className='h-[260px] w-full bg-[#FFFFFF99] text-white absolute top-[30vh] rounded-3xl pt-5' style={{ boxShadow: '0 0 10px rgba(0, 0, 0, 0.5)' }}>
              <div className="slideshow-container text-black">
                ...
                <div className="mySlides fade">
                  ...
                  <div className='w-full flex justify-center'>
                    <div className={`w-[60%] text-[18px] text-center ${rajdhani.className}`}>We help everyone to become fit and healthy and build their dream body type. 💪🌿✨</div>
                  </div>
                </div>
          ...
          <div className='relative px-5'>
            ...
            <div className='absolute top-[220vh]'>
              ...
              <div className='text-black flex flex-row items-center pt-10 bg-[#FFFFFF90]'>
                ...
                <Image src="/lens.png" height={300} width={260} alt='App View' className='me-6' />
              </div>
